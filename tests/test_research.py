...
SCRIPTS = Path(__file__).resolve().parents[1] / "skills/deep-researcher/scripts"
...
class ResearchTests(unittest.TestCase):
    ...
    def complete_run(self):
        ...
        (self.root / "evidence.json").write_text(json.dumps({"fixture": "evidence " * 10000}))
    ...
    def test_archive_prune_restore_exact_bytes(self):
        self.complete_run()
        (self.root / "unregistered.txt").write_text("Leave me alone")
    ...
    def test_unsafe_paths_symlinks_and_existing_directory(self):
        self.init_run()
        ...
        for name in ("../private.txt", str(outside), "link", "a/../private.txt", "C:/private.txt"):
